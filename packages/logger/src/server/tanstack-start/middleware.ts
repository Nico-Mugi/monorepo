 ...
 * @example
 * ```ts
 * import { tanstackStartServerFnLoggerMiddleware } from "@repo/logger/server/tanstack-start/middleware";
 *
...
/**
 * Add evlog request logging to TanStack Start requests.
 *
 * The logger is passed through middleware context as `logger`.
 *
 * @example
 * ```ts
 * import { tanstackStartRequestLoggerMiddleware } from "@repo/logger/server/tanstack-start/middleware";
 *
 * export const startInstance = createStart(() => ({
