...
const calendarLabels: Partial<CalendarLabels> = {
  ...
  colorBlue: m.shared_color_blue(),
  colorGreen: m.shared_color_green(),
  colorRed: m.shared_color_red(),
  colorYellow: m.shared_color_yellow(),
  ...
  dialogCancel: m.shared_action_cancel(),
  ...
  dialogDeleteButton: m.shared_action_delete(),
  dialogDeleteTitle: m.calendar_dialog_delete_title(),
  dialogDeleteDescription: m.calendar_dialog_delete_description(),
  dialogDeleteCancel: m.shared_action_cancel(),
  dialogDeleteContinue: m.shared_action_continue(),
  ...
  dialogDeleteEventButton: m.shared_action_delete(),
  ...
  agendaNoResults: m.shared_no_results_found(),
